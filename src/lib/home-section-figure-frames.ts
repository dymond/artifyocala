...
export const homeFigureFrameInkBorderBuzzShadow =
  "m-0 min-w-0 rounded-xl border-[3px] border-ink shadow-[6px_6px_0_0_var(--color-buzz)]";

export const homeFigureFrameInkBorderSurgeShadow =
  "m-0 min-w-0 rounded-xl border-[3px] border-ink shadow-[6px_6px_0_0_var(--color-surge)]";

export const homeFigureImageClip = "overflow-hidden rounded-[inherit]";
...
export const homeHeroHiringPosterFigure =
  "m-0 w-full min-w-0 max-lg:order-4 -rotate-[0.5deg] rounded-xl border-[3px] border-ink shadow-[6px_6px_0_0_var(--color-surge)] transition-transform duration-300 hover:rotate-0 lg:min-w-0";
