...
export const heroPlayfulCollageCards: ReadonlyArray<CardConfig> = [
  {
    ...
    box: "left-[5%] top-[5%] w-[min(94%,11.5rem)] sm:left-[7%] sm:top-[5%] sm:w-[min(88%,13rem)] lg:left-[6%] lg:top-[3.5%] lg:w-[min(46%,17.5rem)] xl:left-[6%] xl:top-[3.5%] xl:w-[min(46%,19.25rem)]",
    layerDelaySec: 0.8,
    loading: "eager",
    fetchPriority: "high",
  },
  {
    ...
    box: "right-[-2%] top-[11%] w-[min(94%,14.25rem)] sm:right-[0%] sm:top-[13%] sm:w-[min(88%,16.25rem)] lg:right-[2%] lg:top-[2.75%] lg:w-[min(52%,21.5rem)] xl:right-[2%] xl:top-[2.75%] xl:w-[min(52%,23.5rem)]",
    layerDelaySec: 5.5,
    loading: "lazy",
    fetchPriority: "auto",
  },
  {
    ...
    box: "left-[3%] bottom-[2%] w-[min(92%,13.25rem)] sm:left-[5%] sm:bottom-[4%] sm:w-[min(86%,14.75rem)] lg:left-[5%] lg:bottom-[4.75%] lg:w-[min(50%,20.5rem)] xl:left-[5%] xl:bottom-[4.75%] xl:w-[min(50%,22.5rem)]",
    layerDelaySec: 2.9,
    loading: "lazy",
    fetchPriority: "auto",
  },
  {
    ...
    frontStripClass:
      "bg-club font-display text-[0.56rem] font-extrabold uppercase tracking-wide text-ink lg:text-[0.66rem] xl:text-[0.72rem]",
    ...
    box: "right-[1%] bottom-[3%] w-[min(88%,12.25rem)] sm:right-[3%] sm:bottom-[4%] sm:w-[min(82%,13.75rem)] lg:right-[4%] lg:bottom-[4.75%] lg:w-[min(46%,18.75rem)] xl:right-[4%] xl:bottom-[4.75%] xl:w-[min(46%,20.5rem)]",
    layerDelaySec: 7.1,
    loading: "lazy",
    fetchPriority: "auto",
  },
