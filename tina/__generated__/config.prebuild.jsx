...
var config_default = defineConfig({
  ...
  schema: {
    collections: [
        ...
        fields: [
          {
            ...
            required: true,
            ui: {
              description: "Use home for /. Others: about, donate, volunteer (must match filename without .json)."
            }
          },
          {
            type: "string",
          ...
          },
          {
            ...
            list: true,
            ui: {
              description: "Each block uses a template (e.g. Home \u2014 hero). Reorder blocks to change page order."
            },
            templates: [
              {
                name: "pageIntro",
      ...
      {
        name: "siteChrome",
        label: "\u{1D5E6}\u{1D5F6}\u{1D601}\u{1D5F2} \u{1D600}\u{1D5F2}\u{1D601}\u{1D601}\u{1D5F6}\u{1D5FB}\u{1D5F4}\u{1D600}",
        ...
        ui: {
          description: "Global header, wheel menu, and footer (chrome.json). Edit in the form below\u2014no live preview. For logos: upload in Tina Media, then paste the public path (e.g. /images/your-logo.png)."
        },
        fields: [
          {
            type: "string",
            ...
            ui: {
              description: "Light top bar logo. Example: /images/logo-on-light-hollow.png (upload via Media, then paste path). Leave empty for default."
            }
          },
          {
            type: "string",
            ...
            ui: {
              description: "Dark footer wordmark. Example: /images/logo-on-dark-full.png. Leave empty for default."
            }
          },
          {
            type: "string",
